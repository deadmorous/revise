...
using BBox = IndexCubeSplitter2<3>::Block;
...
public:
    ...
    {
        IndexCubeSplitter2<3> splitter{ level, splitCount, default_bbox<3>() };
...
TEST(IndexCubeSplitterTest, BackToFrontOrder)
{
    ...
    auto cube_splitter = IndexCubeSplitter2<dim>{3, 20, default_bbox<dim>()};
