...
class BlockTreeMappedFieldProvider : boost::noncopyable
{
public:
...
private:
            ...
            const ProgressCallback& progressCallback)
    {
        ...
        std::fstream os(fieldMapFileName, std::ios::binary | std::ios::in | std::ios::out | std::ios::trunc);
        if (os.fail())
            ...
            for (auto metadataBlock : level) {
                ...
                if (allSubtreesExist) {
                    ...
                    fieldGenerator.generate(
                                ...
                                subtreeNodes.nodeCount(), noFieldValue(), m_fmap);
                }
